...
const SignupInfluencer = () => {
  ...
  const isFormValid = useFormValidation(values.email, values.password);
        ...
        <div className="flex items-center justify-center min-h-screen bg-white">
          <div className="w-full max-w-md p-4 md:p-8 bg-white rounded-lg relative">
            ...
            <div className="md:flex  items-center justify-center md:space-x-4 m-4">
              <button onClick={() => signIn('google')} className=" flex w-full gap-2 justify-center mb-2 md:mb-0 py-3 px-8 bg-white border rounded-full shadow-sm hover:shadow-md">
                <Image
