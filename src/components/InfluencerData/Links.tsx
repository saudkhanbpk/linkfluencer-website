...
function Links() {
    ...
    return (
        <div className='min-h-screen bg-gray-200 w-full px-3 md:flex items-center justify-around py-[100px]'>
            <div className='text-center flex md:mb-0 mb-10 flex-col justify-center items-center'>
                ...
                <Image className='my-5' src={insta} alt='insta' />
                <div className='md:w-[330px]  rounded-xl'>
                    ...
                    <div className='bg-[#F3C6E2] py-5 px-3 flex gap-2 rounded-t-xl '>
                        ...
                        <div>
                            ...
                            <Image src={youlink} alt='link' />
                        </div>
                    </div>
                    <Image className='rounded-b-xl' src={post} alt='posts' />
                </div>
