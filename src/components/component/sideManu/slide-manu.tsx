...
const menuLinks = [
  { href: "/dashboard", label: "Dashboard", iconSrc: "/images/Dashboard.png" },
  { href: "/mylinks", label: "My Links", iconSrc: "/images/Mylink.png" },
  { href: "#", label: "Bulk Upload", iconSrc: "/images/bulkUpload.png" },
  { href: "/analytics", label: "Analytics", iconSrc: "/images/Analysis.png" },
  { href: "/campaignSoon", label: "Campaign SOON!", iconSrc: "/images/compangSSonn.png" },
];
    ...
    >
      <div className="relative flex items-center justify-center py-4">
        ...
        <div className="mt-8 mx-auto">
          <Image src="/images/Logo.png" alt="Marketz Logo" width={120} height={40} />
        </div>
      </div>
